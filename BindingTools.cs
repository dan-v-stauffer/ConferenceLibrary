...
namespace DataUtilities
{
    public class HierarchicalDataSet : IHierarchicalDataSource
    {
        ...
        public HierarchicalDataSet(DataTable dataTable, string idColumnName, string parentIdColumnName)
        {
            ...
            if (dataTable.Columns[idColumnName].DataType != dataTable.Columns[parentIdColumnName].DataType)
                throw new Exception("The two column names passed should be of the same type");

            columnIsString = dataTable.Columns[idColumnName].DataType == typeof(string);
            System.Diagnostics.Debug.Assert(
                dataTable.Columns[idColumnName].DataType ==
                dataTable.Columns[parentIdColumnName].DataType,
                "The Column of the ID and the Column of the ParentID should be of the same type");
        }
        /// <summary>
        /// The constructor of the class
